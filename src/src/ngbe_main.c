...
#define DRV_VERSION     __stringify(1.2.5.1klos)
#elif defined(CONFIG_EULER_KERNEL)
#define DRV_VERSION     __stringify(1.2.5.1elos)
#elif defined(CONFIG_UOS_KERNEL)
#define DRV_VERSION     __stringify(1.2.5.1uos)
#else
#define DRV_VERSION     __stringify(1.2.5.1)
#endif
...
#endif
	if (adapter->tx_itr_adapt || adapter->rx_itr_adapt)
		ngbe_set_itr(q_vector);
