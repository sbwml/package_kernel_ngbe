Name: ngbe
Summary: WangXun(R) Gigabit PCI Express Ethernet Connection
Version: 1.2.5.1
Release: 1
...
%description
This package contains the Linux driver for the WangXun(R) Gigabit PCI Express Family of Server Adapters.
...
cd %{buildroot}
find lib -name "ngbe.*o" -exec mv {} {}.new \; \
